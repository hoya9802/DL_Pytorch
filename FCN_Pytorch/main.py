...
model_save_path = '/Users/euntaeklee/torch_env/torch_class/FCN/model/'
image_save_path = '/Users/euntaeklee/torch_env/torch_class/FCN/seg_result/'
...
plt.savefig('FCN/train_loss.png')
plt.show()